    ...
    <>
      ...
      >
        <AccordionItem value='item-1'>
          <AccordionTrigger>
            {isLocaleBengali ? 'LWS কার্ট কি?' : 'What is Kartigo?'}
          </AccordionTrigger>
          <AccordionContent>
            {isLocaleBengali
              ...
              : 'Kartigo is an innovative e-commerce platform offering a wide variety of products, from electronics to fashion, with a focus on excellent customer service and fast delivery.'}
          </AccordionContent>
        </AccordionItem>
        <AccordionItem value='item-2'>
          ...
          <AccordionContent>
            {isLocaleBengali
              ...
              : 'You can track your order by logging into your account on Kartigo and navigating to the account page and my orders section. Each order will have a tracking link that you can use to see the current status of your delivery.'}
          </AccordionContent>
        </AccordionItem>
        <AccordionItem value='item-3'>
          ...
          <AccordionContent>
            {isLocaleBengali
              ...
              : 'Kartigo accepts a variety of payment methods including credit/debit cards, PayPal, and popular mobile payment options. We ensure all transactions are secure and encrypted.'}
          </AccordionContent>
        </AccordionItem>
        <AccordionItem value='item-4'>
          ...
          <AccordionContent>
            {isLocaleBengali
              ...
              : 'Yes, Kartigo has a hassle-free return and exchange policy. If you are not satisfied with your purchase, you can return or exchange it within 30 days of delivery, provided the item is in its original condition.'}
          </AccordionContent>
        </AccordionItem>
        <AccordionItem value='item-5'>
          ...
          <AccordionContent>
            {isLocaleBengali
              ...
              : 'You can contact Kartigo customer support through our live chat on the website, via email at support@lwskart.com, or by calling our customer service hotline available 24/7.'}
          </AccordionContent>
        </AccordionItem>
      </Accordion>
    </>
