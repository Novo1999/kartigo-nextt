  ...
  return (
    <nav className='dark:bg-gradient-to-r dark:from-gray-700 dark:to-black bg-teal-700'>
      <div className='container flex '>
        ...
        <div className='flex items-center justify-between flex-grow md:pl-12 py-2 flex-col sm:flex-row'>
          <div className='grid grid-cols-2 gap-2 sm:gap-0 sm:flex items-center sm:space-x-6 capitalize mb-2'>
            {!isAdmin && (
              <>
                <Navlink href={`/${lang}`}>
                  <MdHome />
